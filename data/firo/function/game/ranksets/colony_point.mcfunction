...
execute as @e[type=armor_stand,tag=red] run scoreboard players operation @s bp_point = red bp_point
execute as @e[type=armor_stand,tag=yellow] run scoreboard players operation @s bp_point = yellow bp_point
execute as @e[type=armor_stand,tag=blue] run scoreboard players operation @s bp_point = blue bp_point
execute as @e[type=armor_stand,tag=green] run scoreboard players operation @s bp_point = green bp_point

scoreboard players reset * temp
scoreboard players set @e[type=armor_stand,tag=point_counter] satistics.rank 0

execute as @e[type=armor_stand,tag=point_counter] run scoreboard players operation 1st temp > @s bp_point
execute as @e[type=armor_stand,tag=point_counter] run scoreboard players operation @s temp = @s bp_point
...
# 1位のエンティティを除外
execute as @e[type=armor_stand,tag=point_counter,scores={satistics.rank=0}] run scoreboard players operation 2nd temp > @s bp_point
execute as @e[type=armor_stand,tag=point_counter,scores={satistics.rank=0}] run scoreboard players operation @s temp = @s bp_point
...
# 1位と2位のエンティティを除外
execute as @e[type=armor_stand,tag=point_counter,scores={satistics.rank=0}] run scoreboard players operation 3rd temp > @s bp_point
execute as @e[type=armor_stand,tag=point_counter,scores={satistics.rank=0}] run scoreboard players operation @s temp = @s bp_point
