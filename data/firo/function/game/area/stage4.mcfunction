...
clone 42 -60 192 69 -60 198 42 -60 192 filtered red_concrete force
execute store result score blue game.area.blockCount run \
clone 42 -60 192 69 -60 198 42 -60 192 filtered blue_concrete force
execute store result score green game.area.blockCount run \
clone 42 -60 192 69 -60 198 42 -60 192 filtered green_concrete force
execute store result score yellow game.area.blockCount run \
clone 42 -60 192 69 -60 198 42 -60 192 filtered yellow_concrete force
