...
clone 35 -60 104 45 -60 114 35 -60 104 filtered red_concrete force
execute store result score blue game.area.blockCount run \
clone 35 -60 104 45 -60 114 35 -60 104 filtered blue_concrete force
execute store result score green game.area.blockCount run \
clone 35 -60 104 45 -60 114 35 -60 104 filtered green_concrete force
execute store result score yellow game.area.blockCount run \
clone 35 -60 104 45 -60 114 35 -60 104 filtered yellow_concrete force
