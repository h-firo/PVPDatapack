...
scoreboard players set red bp_point 1
scoreboard players set blue bp_point 1
scoreboard players set green bp_point 1
scoreboard players set yellow bp_point 1
...
scoreboard players set maxTime game.settings 3600
...
scoreboard players set stage game.settings 1
...
scoreboard players set @a totalDeathCount 0
...
say 全プレイヤーのスコアをリセットしました[server,@a]